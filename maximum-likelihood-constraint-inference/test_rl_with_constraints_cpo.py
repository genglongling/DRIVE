#!/usr/bin/env python3
"""
Test script for RL with Constraints - CPO Version
"""
...
if __name__ == "__main__":
    ...
    for i, track_id in enumerate(remaining_tracks[:7]):  # Generate for 7 more tracks
        ...
        # Generate trajectory
        trajectory, actions, rewards = generate_cpo_rl_trajectories(
            rl_agent, initial_state, generation_df, max_steps=50
        )
    ...
    with open('./trajectory_data/generation_results_cpo.pkl', 'wb') as f:
    ...
    print(f"Generation results saved to: ./trajectory_data/generation_results_cpo.pkl") 