#!/usr/bin/env python3
"""
Test script for RL with Constraints - Convex Optimization Version
"""
...
if __name__ == "__main__":
    ...
    with open('./trajectory_data/generation_results_convex.pkl', 'wb') as f:
    ...
    print(f"Generation results saved to: ./trajectory_data/generation_results_convex.pkl") 