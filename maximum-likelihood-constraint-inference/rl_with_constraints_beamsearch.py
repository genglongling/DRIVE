...
if __name__ == "__main__":
    ...
    # Create generation dataset (20% of tracks)
    ...
    # Train RL agent using training dataset (80%)
    print("\n=== Training RL Agent (80% of tracks) ===")
    ...
    # Generate trajectories using generation dataset (20%)
    print("\n=== Generating Trajectories (20% of tracks) ===")
    
    # Extract realistic goals from generation dataset
    generation_goals = extract_realistic_goals(generation_df, num_goals=10)
    ...
    for i, track_id in enumerate(generation_track_ids[:10]):  # Generate for first 10 tracks
        ...
        print(f"Generating trajectory {i+1}/10: Track {track_id}, Goal {goal_pos}")
    ...
    generation_results = {
        'track_ids': generation_track_ids[:10],
        'trajectories': generated_trajectories,
        'rewards': generated_rewards,
        'final_positions': generated_final_positions,
        'goals': generation_goals[:10]
    }
    
    with open('./trajectory_data/generation_results.pkl', 'wb') as f:
    ...
    print(f"Generation results saved to: ./trajectory_data/generation_results.pkl") 